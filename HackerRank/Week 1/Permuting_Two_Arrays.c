...
int compare_ascending(const void *a, const void *b) { // void is typecasted and if the difference is greater than 0 b comes first else a , done automatically for each pair
    return (*(int *)a - *(int *)b);
}
